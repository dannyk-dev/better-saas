...
import { Avatar, Button, Card, CardBody as CardContent, CardHeader, Input } from '@heroui/react';
			...
			<div className='grid gap-6'>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>{t('avatar.description')} 仅支持 JPEG 和 PNG 格式，最大 10MB</CardDescription>
					</CardHeader>
					<CardContent>
				...
				<Card>
					...
					<CardContent>
						<div className='flex gap-4'>
							...
							<Button onPress={handleUpdateName} variant='bordered' disabled={isUpdatingName || !hasNameChanged}>
								{isUpdatingName ? (
									<>
				...
				<Card>
					...
					<CardContent>
						<div className='flex gap-4'>
							...
							<Button onClick={handleSaveEmail} variant='bordered' disabled>
								{t('save')}
							</Button>
						</div>
