...
import { Button, Card, CardBody as CardContent, CardHeader } from '@heroui/react';
		...
		<div className='mx-auto max-w-4xl space-y-6'>
			...
			<Card className='border border-gray-200 shadow-sm'>
				<CardHeader className='pb-4'>
					<CardTitle className='font-medium text-gray-900 text-lg'>{t('resetPassword.title')}</CardTitle>
			...
			<Card className='border border-red-200 shadow-sm'>
				<CardHeader className='pb-4'>
					<CardTitle className='font-medium text-lg text-red-600'>{t('deleteAccount.title')}</CardTitle>
