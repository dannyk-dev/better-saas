...
export function LoginForm({
	...
	return (
		<div className={cn('flex flex-col gap-6', className)} {...props}>
			<Card>
				<CardHeader className='text-center flex flex-col pb-3'>
						...
						<div className='grid gap-6'>
							...
							{error && (
								<div className='rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-red-600 text-sm'>
									{error}
									<button type='button' onClick={onClearError} className='ml-2 underline hover:no-underline'>
										{t('closeError')}
									</button>
								</div>
							)}
							...
							<div className='relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-border after:border-t'>
								<span className='relative z-10 bg-card px-2 text-muted-foreground'>{t('orUseEmail')}</span>
							</div>
                    ...
                    labelPlacement='outside-top'
								...
								<div className='grid gap-3'>
									<Input
										...
										labelPlacement='outside-top'
										description={
											<Link href='/reset-password' className='underline-offset-4 hover:underline text-xs text-gray-500'>
												{t('forgotPassword')}
											</Link>
										}
										label={t('password')}
