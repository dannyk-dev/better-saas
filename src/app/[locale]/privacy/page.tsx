		...
		<div className='min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50'>
			...
			<div className='bg-white/80 backdrop-blur-sm border-b sticky top-0 z-10'>
				<div className='container mx-auto max-w-6xl px-4 py-4'>
					<div className='flex items-center justify-between'>
						<Link href='/'>
							<Button variant='flat' size='sm' className='gap-2'>
			...
			<div className='container mx-auto max-w-4xl px-4 py-12'>
				...
				<div className='mb-16 text-center'>
					...
					<p className='text-lg text-muted-foreground max-w-2xl mx-auto mb-6'>{t('introduction')}</p>
				...
				<div className='space-y-8'>
					{sections.map((section, index) => {
						...
						return (
							<Card
								key={section.key}
								className='group hover:shadow-lg transition-all duration-300 border-0 shadow-md bg-white/70 backdrop-blur-sm'
							>
								<CardHeader className='pb-4'>
									<div className='flex items-center gap-3'>
										...
										<div>
											<CardTitle className='text-xl font-semibold text-gray-900'>{t(`${section.key}.title`)}</CardTitle>
											<div className='w-12 h-0.5 bg-gradient-to-r from-emerald-500 to-teal-600 mt-1' />
										</div>
									</div>
								</CardHeader>
								<CardContent>
									<p className='text-gray-700 leading-relaxed text-base'>{t(`${section.key}.content`)}</p>
								</CardContent>
							</Card>
						);
					})}
